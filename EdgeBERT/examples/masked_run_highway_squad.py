...
from transformers.modeling_highway_albert import AlbertForQuestionAnswering as AlbertForQuestionAnsweringHW
from transformers.modeling_albert import AlbertForQuestionAnswering as AlbertForQuestionAnswering
from transformers.modeling_albert_masked import MaskedAlbertConfig #MaskedAlbertForSequenceClassification
from transformers.modeling_highway_albert_masked import MaskedAlbertForQuestionAnswering
...
ALL_MODELS = sum((tuple(conf.pretrained_config_archive_map.keys()) for conf in (AlbertConfig, BertConfig)), ())
...
MODEL_CLASSES = {
    ...
    'masked_albert': (MaskedAlbertConfig, MaskedAlbertForQuestionAnswering, AlbertTokenizer),
}
...
def train(args, train_dataset, model, tokenizer, prune_schedule=None, teacher=None, train_highway=False):
    """ Train the model """
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if "teacher" not in args.model_type:
            ...
            loss, start_logits_stu, end_logits_stu = outputs[:3]
...
def main():
    ...
    if args.model_type == "albert" or args.model_type == "masked_albert":
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            # Evaluate
            result = evaluate(args, model, tokenizer, prefix=global_step, eval_highway=args.eval_highway)
