...
class AlbertAttention(BertSelfAttention):
    ...
    def forward(self, input_ids, attention_mask=None, head_mask=None, threshold=None):
        ...
        mixed_key_layer = self.key(input_ids, threshold=threshold)
        mixed_value_layer = self.value(input_ids, threshold=threshold)
...
class AlbertLayerGroup(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask=None, head_mask=None, threshold=None):
        ...
        for layer_index, albert_layer in enumerate(self.albert_layers):
            layer_output = albert_layer(hidden_states, attention_mask, head_mask[layer_index], threshold=threshold)
...
class MaskedAlbertPreTrainedModel(PreTrainedModel):
...
MASKED_ALBERT_START_DOCSTRING = r"""
...
MASKED_ALBERT_INPUTS_DOCSTRING = r"""
    Args:
