...
from .modeling_bert_masked import MaskedBertPreTrainedModel, BertLayer
...
class MaskedBertModel(MaskedBertPreTrainedModel):
    ...
    """
    def __init__(self, config, params):
        super(MaskedBertModel, self).__init__(config, params)
        self.config = config
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None,
                head_mask=None, inputs_embeds=None, encoder_hidden_states=None, encoder_attention_mask=None, threshold=None):
...
class MaskedBertForSequenceClassification(MaskedBertPreTrainedModel):
    ...
    """
    def __init__(self, config, params):
        super(MaskedBertForSequenceClassification, self).__init__(config, params)
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None,
                ...
                output_layer=-1, train_highway=False, threshold=None):
