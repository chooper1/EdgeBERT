...
python ../examples/masked_run_highway_glue.py \
  ...
  --seed 42 \
  --output_dir ./saved_models/${MODEL_TYPE}-${MODEL_SIZE}/$DATASET/simultaneous_${FINAL_THRESH} \
  ...
  --teacher_type albert_teacher --teacher_name_or_path /n/holyscratch01/acc_lab/chooper/albert-py/DeeBERT-albert/scripts/saved_models/masked_albert-base/$DATASET/bertarized_two_stage_pruned_1_distil \
